...
#### I am currently working as a Postdoctoral Researcher in the Department of Computer Science and Engineering at The Chinese University of Hong Kong (CUHK), affiliated with the Applied Distributed Systems Lab (ADSLab) and supervised by Prof. [Patrick P. C. Lee](https://www.cse.cuhk.edu.hk/~pclee/) since July 2026. Previously, I obtained my Ph.D. degree in Computer System Architecture from Huazhong University of Science and Technology (HUST), Wuhan, China, in June 2026. My PhD research was supervised by Prof. [Yuchong Hu](http://yuchonghu.com/), and I was a member of the Data Storage and Applications Laboratory (DSAL) led by Prof. [Dan Feng](https://storage.hust.edu.cn/index.htm). I received my M.S. degree from Sichuan University (SCU) in June 2022 under the supervision of Prof. [Min Zhu](https://scuvis.org/).
...
<!-- 🔥 -->
# 🔥 News
- *2026.09*: &nbsp;🌻🎉 I served as a member of the China Computer Federation (CCF) Technical Committee on Information Storage (TCIST).
- *2026.08*: &nbsp;🌻🎉 I served as a member of the ATC2026 Artifact Evaluation Committee (AEC), responsible for artifact evaluation and reproducibility review of conference papers.
...
-	__<u>Zhangqiang Ming</u>__, Yuchong Hu, Patrick P. C. Lee, Yuanhao Shu, Wenxiang Zhou, Xinjue Zheng, and Dan Feng. "Enabling Efficient All-Dimension Top-k Sparsification for High-Performance Distributed DNN Training Systems."ACM Transactions on Architecture and Code Optimization (ACM TACO, CCF-A, __CSRanking__)[[Code]](https://github.com/zqming-cs) [[Preview]](https://dl.acm.org/doi/10.1145/3832779))[[Download]](https://dl.acm.org/doi/10.1145/3832779)
...
-	Min Zhu, __<u>Zhangqiang Ming*</u>__, Jianrong Yan, Yong Yang, and Jiamin Zhu. "A survey on generative adversarial network based person re-identification method." Journal of Computer-Aided Design&amp;Computer Graphics 34, no. 2 (2022): 163-179. (__Corresponding author
__, __CAD&amp;CG__, T1/CCF-A) [[Preview]](https://zhangqiangming.github.io/papers/5_CADCG2021_.pdf)[[Download]](https://zhangqiangming.github.io/papers/5_CADCG2021_.pdf)
